...
bool read_private_key(eliptic_curve_key& key, const std::string& arg)
{
...
bool read_private_key(eliptic_curve_key& key)
{
...
bool read_public_or_private_key(eliptic_curve_key& key)
{
